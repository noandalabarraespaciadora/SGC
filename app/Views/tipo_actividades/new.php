...
<div class="az-dashboard-one-title">
    <div>
        <h2 class="az-dashboard-title">➕ Nuevo Tipo de Actividad</h2>
        <p class="az-dashboard-text">Complete el formulario para crear un nuevo tipo de actividad</p>
    </div>
</div>
...
<div class="card shadow-sm">
    <div class="card-body">
        ...
        <form method="post" action="<?= base_url('tipo-actividades/crear') ?>">
            <?= csrf_field() ?>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="actividad"
                    value="<?= old('actividad') ?>"
                    placeholder="Ej: Apertura de Sobres" required maxlength="255">
