...
<head>
    ...
    <style>
      ...
      @media (max-width: 575.98px) {
        ...
        .az-dashboard-title { font-size: 1.25rem; }
        .card-title { font-size: 0.9rem; }
        .az-header h2 { font-size: 1.25rem; }
      }
      @media (max-width: 767.98px) {
        .az-header-menu {
          position: fixed; top: 0; left: -280px; width: 280px; height: 100vh;
          background: #fff; z-index: 1050; transition: all 0.3s; overflow-y: auto;
          box-shadow: 0 0 15px rgba(0,0,0,.1);
        }
        .az-header-menu.show { left: 0; }
        .az-header-menu .close { position: absolute; top: 15px; right: 15px; font-size: 1.5rem; color: #333; }
        .az-content { margin-top: 60px; }
        .table-dashboard th, .table-dashboard td { padding: 0.5rem; }
      }
      .az-overlay {
