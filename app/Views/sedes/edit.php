...
<div class="az-dashboard-one-title">
    <div>
        <h2 class="az-dashboard-title">✏️ Editar Sede</h2>
        <p class="az-dashboard-text">Modifique los datos de la sede</p>
    </div>
</div>
...
<div class="card shadow-sm">
    <div class="card-body">
        ...
        <form method="post" action="<?= base_url("sedes/actualizar/{$sede['id']}") ?>">
            <?= csrf_field() ?>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="denominacion" 
                       value="<?= old('denominacion', $sede['denominacion']) ?>" required maxlength="255">
