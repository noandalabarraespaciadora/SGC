...
<div class="az-dashboard-one-title">
    <div>
        <h2 class="az-dashboard-title">➕ Nuevo Concurso</h2>
        <p class="az-dashboard-text">Complete el formulario para crear un nuevo concurso</p>
    </div>
</div>
...
<div class="card shadow-sm">
    <div class="card-body">
        ...
        <form method="post" action="<?= base_url('concursos/crear') ?>">
            <?= csrf_field() ?>
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control" name="numero_expediente"
                        ...
                        placeholder="Ej: 971/25" required maxlength="50">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <select class="form-select" name="id_estado_concurso">
                        ...
                        <?php foreach ($estados as $estado): ?>
                            <option value="<?= $estado['id'] ?>" <?= old('id_estado_concurso') == $estado['id'] ? 'selected' : '' ?>>
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control" name="caratula" rows="3" required
                    placeholder="Descripción completa del cargo"><?= old('caratula') ?></textarea>
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control" name="resolucionSTJ"
                        value="<?= old('resolucionSTJ') ?>" placeholder="Ej: 512 - 10.06.22" maxlength="100">
                </div>

                <div class="col-md-6 mb-3">
                    <label class="form-label">Comunicación al CM</label>
                    <input type="text" class="form-control" name="comunicacionCM"
                        value="<?= old('comunicacionCM') ?>" placeholder="Ej: Oficio 2000 - 16.06.22" maxlength="100">
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <select class="form-select" name="id_unificado">
                        ...
                        <?php foreach ($unificados as $unificado): ?>
                            <option value="<?= $unificado['id'] ?>" <?= old('id_unificado') == $unificado['id'] ? 'selected' : '' ?>>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control" name="propuestas_nro_oficio"
                        value="<?= old('propuestas_nro_oficio') ?>" placeholder="Número de oficio" maxlength="100">
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="date" class="form-control" name="propuestas_fecha"
                        value="<?= old('propuestas_fecha') ?>">
                </div>

                <div class="col-md-6 mb-3">
                    <label class="form-label">Resultado de Votación</label>
                    <input type="text" class="form-control" name="resultadoVotacion"
                        value="<?= old('resultadoVotacion') ?>" placeholder="Ej: Propuesto por Unanimidad" maxlength="255">
                </div>
            </div>
            ...
            <div class="mb-3">
                ...
                <div class="form-text">Agregue los docentes que forman parte de la comisión examinadora.</div>
            </div>

            <div class="mb-3">
                <label class="form-label">Observaciones</label>
                <textarea class="form-control" name="observaciones" rows="2"
                    placeholder="Observaciones adicionales del concurso"><?= old('observaciones') ?></textarea>
            </div>

            <button type="submit" class="btn btn-success">
                <i class="fas fa-save"></i> Guardar Concurso
            </button>
