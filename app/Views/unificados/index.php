        ...
        if (confirm(`¿Está seguro de eliminar la unificación "${denominacion}"?`)) {
            ...
            <?php if (session()->getFlashdata('success')): ?>
                ...
                <?php if (session()->getFlashdata('error')): ?>
                    ...
                    th scope = "col" > Denominación < /th> <
                    th scope = "col"
                    class = "d-none-mobile" > Fecha Creación < /th> <
                    th scope = "col"
                    width = "150"
                    class = "no-print" > Acciones < /th> < /
                    tr > <
                        /thead> <
                    tbody id = "unificadosList" >
                        <?php if (empty($unificados)): ?> <
                    ...
                    h4 > No se encontraron unificaciones < /h4> <
                    p > No hay unificaciones registradas en el sistema. < /p> <
                    a href = "<?= base_url('unificados/nuevo') ?>"
                ...
                <?php else: ?>
                    <?php foreach ($unificados as $unificado): ?>
                        ...
                        role = "group" >
                            <
                            a href = "<?= base_url("unificados/{$unificado['id']}") ?>"
                        class = "btn btn-outline-primary"
                        title = "Ver detalles" >
                            <
                            i class = "fas fa-eye" > < /i> < /
                        a > <
                            a href = "<?= base_url("unificados/editar/{$unificado['id']}") ?>"
